        ...
        <Container>
          <Navbar.Brand className="navbar-brand-spacing black-text">
            <Link href="/" passHref legacyBehavior>
              <Nav.Link style={{ color: colors.color_black }}>
                Jim Chen's Website
              </Nav.Link>
            </Link>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <Link href="/about" passHref legacyBehavior>
                <Nav.Link style={{ color: colors.color_black }}>About</Nav.Link>
              </Link>
              <Link href="/" passHref legacyBehavior>
                <Nav.Link style={{ color: colors.color_black }}>Blog</Nav.Link>
              </Link>
              <Link href="/comments" passHref legacyBehavior>
                <Nav.Link style={{ color: colors.color_black }}>Comments</Nav.Link>
              </Link>
